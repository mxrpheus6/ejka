...
import by.kazachenko.ejka.common.exception.custom.ReviewNotFoundException;
...
public class ReviewServiceImpl implements ReviewService {
    ...
    public ReviewResponse createReview(ReviewRequest request) {
        ...
        if (cacheManager.getCache("productsById") != null) {
            cacheManager.getCache("productsById").evict(request.productId());
        }
        if (cacheManager.getCache("productsByBarcode") != null) {
            cacheManager.getCache("productsByBarcode").clear();
        }
    ...
    public void deleteReviewById(UUID id) {
        ...
        if (cacheManager.getCache("productsById") != null) {
            cacheManager.getCache("productsById").evict(productId);
        }
        if (cacheManager.getCache("productsByBarcode") != null) {
            cacheManager.getCache("productsByBarcode").clear();
        }
