...
public interface ProductRepository extends JpaRepository<Product, UUID>,
    ...
    @Modifying
    @Query(value = "DELETE FROM product_additives WHERE additive_id = :additiveId", nativeQuery = true)
    void deleteAdditiveLinks(@Param("additiveId") Long additiveId);

    int countByCreatorIdAndModerationStatus(UUID creatorId, ModerationStatus status);
}
